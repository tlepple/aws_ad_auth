...
> Open a chrome browser on your host and give it the URL `https://microsoft.com/devicelogin`.   
> It will ask you to enter the code from your container `<your specfic code>`.   
> From here you will select your Microsoft AD account.  
> Then click the `Continue` button from the next screen.
> If all is working you should see the follow image.
